/*
 ...
 NUMBER: 11
 DESCRIPTION: When with bound value and cast expressions in when entry.
 */

fun test1(value: Collection<Int>?, value1: Collection<Int>, value2: Collection<Int>?): Int = when (value) {
...
fun test2(value: Collection<Int>?, value1: Collection<Int>, value2: Collection<Int>?): Int {
    when (value) {
