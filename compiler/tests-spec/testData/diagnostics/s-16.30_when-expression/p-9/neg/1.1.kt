...
// CASE DESCRIPTION: Checking all types except the correct one (custom types) in 'when' without bound value_1.
...
// CASE DESCRIPTION: Checking all types except the correct one (custom types) in 'when' with bound value_1.
...
/*
 CASE DESCRIPTION: Checking all types except the correct one (numbers) in 'when' without bound value_1.
...
/*
 CASE DESCRIPTION: Checking all types except the correct one (numbers) in 'when' with bound value_1.
 UNEXPECTED BEHAVIOUR
 ISSUES: KT-25268
 */
...
// CASE DESCRIPTION: Checking all types except the Any (implicit cast to any) in 'when' without bound value_1.
...
// CASE DESCRIPTION: Checking all types except the Any (implicit cast to any) in 'when' with bound value_1.
