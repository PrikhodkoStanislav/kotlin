...
// CASE DESCRIPTION: Checking correctness type (custom types) in 'when' without bound value_1.
...
// CASE DESCRIPTION: Checking correctness type (custom types) in 'when' with bound value_1.
...
/*
 CASE DESCRIPTION: Checking correctness type (numbers) in 'when' without bound value_1.
...
/*
 CASE DESCRIPTION: Checking correctness type (numbers) in 'when' with bound value_1.
 UNEXPECTED BEHAVIOUR
 ISSUES: KT-25268
 */
...
// CASE DESCRIPTION: Checking Any type (implicit cast to any) in 'when' without bound value_1.
...
// CASE DESCRIPTION: Checking Any type (implicit cast to any) in 'when' with bound value_1.
