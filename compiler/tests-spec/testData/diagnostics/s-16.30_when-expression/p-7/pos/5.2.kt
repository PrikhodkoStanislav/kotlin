...
fun case_2(value_1: Number, value_1: Int) {
    when (value_1) {
        -.09 % 10L, value_1 / -5, getByte(99) - 11 + 90 -> {}
    }
}
...
fun case_3(value_1: Boolean, value_1: Boolean, value_2: Long) {
    when (value_1) {
        value_1, !value_1, getBoolean() && value_1, getChar(10) != 'a' -> {}
        getList() === getAny(), value_2 <= 11 -> {}
    }
}
...
fun case_4(value_1: String, value_1: String, value_2: String) {
    when (value_1) {
        "..." + value_1 + "" + "$value2" + "...", value_1 + getString() -> {}
    }
}
...
fun case_6(value_1: Int, value_1: Int) {
    when (value_1) {
        if (value_1 > 1000) 1 else 2, if (value_1 < 100) 1 else if (value_1 < 10) 2 else 3 -> {}
    }
}
...
fun case_7(value_1: Any, value_1: String, value_2: String) {
    when (value_1) {
        try { 4 } catch (e: Exception) { 5 }, try { throw Exception() } catch (e: Exception) { value_1 }, try { throw Exception() } catch (e: Exception) { {value_2} } finally { } -> {}
    }
}
...
fun case_8(value_1: Int, value_1: Int?, value_2: Int?) {
    when (value_1) {
        value_1 ?: 0, value_1 ?: value_2 ?: 0, value_1!! <!USELESS_ELVIS!>?: 0<!> -> {}
    }
}
...
fun case_10(value_1: Collection<Int>, value_1: Collection<Int>, value_2: Collection<Int>?) {
    when (value_1) {
        value_1 as MutableList<Int>, value_1 <!USELESS_CAST!>as? MutableList<Int><!> -> {}
        value_2 <!UNCHECKED_CAST!>as? MutableMap<Int, Int><!>, (value_1 <!UNCHECKED_CAST!>as? Map<Int, Int><!>) as MutableMap<Int, Int> -> {}
    }
}
...
fun case_11(value_1: Any, value_1: Int, value_2: Int, value_3: Boolean) {
    ...
    when (value_1) {
        ++mutableValue1, --mutableValue2, !value_3 -> {}
    }
}
...
fun case_12(value_1: Int, value_1: Int, value_2: Int, value_3: Int?) {
    ...
    when (value_1) {
        <!UNUSED_CHANGED_VALUE!>mutableValue1++<!>, <!UNUSED_CHANGED_VALUE!>mutableValue2--<!>, value_3!! -> {}
    }
}
...
fun case_14(value_1: Any, value_1: _Class, value_2: _Class?, value_3: Int) {
    ...
    when (value_1) {
        _fun(), __fun_1()(), value_1.fun_2(value_3) -> {}
        value_2?.fun_2(value_3), value_2!!.fun_2(value_3) -> {}
    }
}
...
fun case_15(value_1: Int, value_1: _Class, value_2: _Class?) {
    when (value_1) {
        value_1.prop_1, value_2?.prop_2 -> {}
        value_1::prop_1.get(), value_2!!::prop_3.get() -> {}
    }
}
