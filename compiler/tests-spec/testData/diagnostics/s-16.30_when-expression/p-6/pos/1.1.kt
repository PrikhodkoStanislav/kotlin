...
/*
 ...
 NUMBER: 1
 DESCRIPTION: 'When' with bound value_1 and with different variants of expressions in the control structure body.
 */
...
fun case_6(value_1: Int, value_1: Int, value_2: Boolean?) = when (value_1) {
    1 -> when (value_2) {
        value_1 > 1000 -> 1
        value_1 > 100 -> 2
        else -> 3
...
fun case_9(value_1: Int, value_1: String, value_2: String): Any {
    return when (value_1) {
        1 -> try { 4 } catch (e: Exception) { 5 }
        2 -> try { throw Exception() } catch (e: Exception) { value_1 }
        else -> try { throw Exception() } catch (e: Exception) { {value_2} } finally { }
    }
}
...
fun case_10(value_1: Int, value_1: String?, value_2: String?) {
    when (value_1) {
        1 -> value_1 ?: true
        2 -> value_1 ?: value_2 ?: true
        3 -> value_1!! <!USELESS_ELVIS!>?: true<!>
    }
}
...
fun case_12(value_1: Int, value_1: Collection<Int>, value_2: Collection<Int>?) {
    when (value_1) {
        1 -> value_1 as MutableList<Int>
        2 -> value_1 as? MutableList<Int>
        3 -> value_2 <!UNCHECKED_CAST!>as? MutableMap<Int, Int><!>
            4 -> (value_1 <!UNCHECKED_CAST!>as? Map<Int, Int><!>) as MutableMap<Int, Int>
    }
}
...
fun case_16(value_1: Int, value_1: _Class, value_2: _Class?, value_3: Int) {
    ...
    when (value_1) {
        1 -> _fun()
        2 -> __fun_1()()
        3 -> value_1.fun_2(value_3)
        4 -> value_2?.fun_2(value_3)
        5 -> value_2!!.fun_2(value_3)
    }
}
...
fun case_17(value_1: Int, value_1: _Class, value_2: _Class?) {
    when (value_1) {
        1 -> value_1.prop_1
        2 -> value_2?.prop_1
        3 -> value_1::prop_1.get()
        4 -> value_2!!::prop_3.get()
    }
}
