...
/*
 ...
 NUMBER: 1
 DESCRIPTION: 'When' without bound value_1 and different variants of the boolean conditions (logical, equality, comparison, type checking operator, containment operator).
 */
...
/*
 ...
 NOTE: for potential analysis on exhaustive by enum of when without bound value_1.
 */
...
/*
 CASE DESCRIPTION: 'When' with boolean expressions.
 NOTE: for potential analysis on exhaustive by boolean of when without bound value_1.
 */
...
/*
 ...
 NOTE: for potential analysis on exhaustive of when without bound value_1.
 */
...
/*
 ...
 NOTE: for potential analysis on exhaustive by sealed class of when without bound value_1.
 */
...
fun case_9(value_1: Int, value_1: IntRange) {
    when {
        value_1 in -10..100L -> {}
        value_1 in value_1 -> {}
