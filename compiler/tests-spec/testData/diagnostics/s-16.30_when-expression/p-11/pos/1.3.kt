...
/*
 ...
 NUMBER: 3
 DESCRIPTION: Check when exhaustive via else entry (when with bound value_1, redundant else).
 */
...
// CASE DESCRIPTION: Checking for redundant 'else' branch (all enum values and null value_1 covered).
...
// CASE DESCRIPTION: Checking for redundant 'else' branch (both boolean value_1 covered).
...
// CASE DESCRIPTION: Checking for redundant 'else' branch (both boolean value_1 and null value_1 covered).
...
// CASE DESCRIPTION: Checking for redundant 'else' branch (all sealed class subtypes and null value_1 covered).
...
// CASE DESCRIPTION: Checking for redundant 'else' branch (sealed class itself and null value_1 covered).
