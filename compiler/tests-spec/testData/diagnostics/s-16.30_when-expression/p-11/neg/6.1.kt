...
/*
 ...
 NUMBER: 1
 DESCRIPTION: Checking for not exhaustive 'when' when not covered by all possible subtypes or 'when' does not have bound value_1.
 */
...
// CASE DESCRIPTION: Checking for not exhaustive 'when' without bound value_1 on the Sealed class with all subtypes covered.
