...
fun case_6(value1: Number) {
    when {
        value1.case_6_1() -> println(value1.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
    }
    when {
        !value1.case_6_2() -> println(value1.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
    }
    when {
        value1.case_6_3() != null -> println(value1.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
    }
}
...
fun case_8(value1: String?, value2: String?) {
    when {
        value1.case_8_1() -> println(<!DEBUG_INFO_CONSTANT!>value1<!><!UNSAFE_CALL!>.<!>length)
    }
    when {
        value2.case_8_2() -> println(value2)
    }
    when {
